    ...
    _createClass(MetaList, [{
        ...
        value: function isLockedOnClick() {
            ...
            $('#metalistvalueid-islocked').on('click', function () {
                var element = document.getElementById('metalistvalueid-islocked');
                var islocked = element.innerHTML === 'true';
                myAjax.updateRegularFile(_this2.props.id, {
                    islocked: !islocked
                }).then(function () {
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(TabulatorUserACL, { type: this.props.type, id: this.props.id, acls: this.props.user_acls }),
                React.createElement('br', null),
                React.createElement(TabulatorGroupACL, { type: this.props.type, id: this.props.id, acls: this.props.dir_acls })
            );
        }
    }]);
