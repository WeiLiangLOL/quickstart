...
class MetaList extends React.Component {
    ...
    isLockedOnClick() {
        $('#metalistvalueid-islocked').on('click', () => {
             ...
             myAjax.updateRegularFile(this.props.id, {
                 islocked: !islocked,
             }).then(() => {
    ...
    render() {
        return (
            <React.Fragment>
                        ...
                        Object.keys(this.props.data).map((key) => {
                            return (
                                <tr key={"metalistdatakey-" + key}>
                                    ...
                                    <td id={"metalistvalueid-" + key}>{this.props.data[key]}</td>
                                </tr>
                            );
                        })
                    }
                ...
                <TabulatorUserACL type={this.props.type} id={this.props.id} acls={this.props.user_acls} />
                <br/>

                <TabulatorGroupACL type={this.props.type} id={this.props.id} acls={this.props.dir_acls} />
